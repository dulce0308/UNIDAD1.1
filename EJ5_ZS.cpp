...
float longitud_en metros, longitud_en_pies, peso_en_kilogramos, peso_en_toneladas;
...
cout<< "Valor de longitud en metros:"<< longitud_en_metros << end]; 
cout <<"Valor de peso en kilogramos:"<< peso_en _kilogramos<< endl;
cout << endl;
system ("pause");
return EXIT_SUCCESS;
}
